<style>
    *{ldelim}margin: 0;padding: 0;-webkit-box-sizing: border-box;box-sizing: border-box;outline: none;border: none;text-transform: capitalize;-webkit-transition: all 0.2s ease-out;transition: all 0.2s ease-out;text-decoration: none;{rdelim}
    ...
    .tecSee-table-parent .tecSee-table-container .tecSee-remove-padding .tecSee-table tr td.control-height div {ldelim}
    max-height: 200px;
    overflow-y: auto;
    {rdelim}

    @media screen and (max-width: 768px) {ldelim}
    .tecSee-form div, .tecSee-form .full-width {ldelim}
